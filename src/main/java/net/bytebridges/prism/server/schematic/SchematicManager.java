package net.bytebridges.prism.server.schematic;
...
public class SchematicManager {
    ...
    public static Schematic scan(Instance instance, Pos pos, Pos pos2, Pos copyPosition) {
